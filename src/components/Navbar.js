      ...
      <div className='flex gap-8 items-center text-2xl'>
        ...
        <div className='flex items-center justify-center gap-5'>
          ...
          <div className='flex gap-8 items-center text-xl'>
            ...
            <img src='https://images.unsplash.com/photo-1682686578601-e7851641d52c?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'alt='profile logo' className='w-9 h-9 rounded-full'/>
          </div>
